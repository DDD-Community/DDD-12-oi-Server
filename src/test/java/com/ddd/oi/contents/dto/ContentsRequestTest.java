...
class ContentsRequestTest {
    ...
    void 생성요청_예외처리() {
        ...
        OiException 예외1 = assertThrows(OiException.class, () -> new ContentsCreateRequest(null, "desc", 100, "추천", 1,
            ContentsTag.TRAVEL, "짧은제목", "짧은설명", "imageUrl", 4.5, BadgeType.NONE));
        ...
        OiException 예외3 = assertThrows(OiException.class,
            () -> new ContentsCreateRequest("제목", "desc", 100, "추천", 1, null, "짧은제목", "짧은설명", "imageUrl", 4.5, BadgeType.NONE));
    ...
    void 수정요청_예외처리() {
        ...
        // contentsTag null
        OiException 예외3 = assertThrows(OiException.class,
            () -> new ContentsUpdateRequest("제목", "desc", 100, "추천", 1, null, "짧은제목", "짧은설명", "imageUrl", 4.5, BadgeType.NONE));
        assertThat(예외3.getErrorCode()).isEqualTo(ErrorCode.PARAMETER_INVALID);
        // cost 음수
