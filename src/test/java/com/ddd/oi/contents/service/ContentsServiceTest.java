...
class ContentsServiceTest {
	...
	void 컨텐츠_생성_및_조회_성공() {
		ContentsCreateRequest 요청 = new ContentsCreateRequest("제목", "설명", 10000, "추천일정", 3, ContentsTag.TRAVEL, "짧은제목",
	...
	void 컨텐츠_수정_성공() {
		ContentsCreateRequest req = new ContentsCreateRequest("제목", "설명", 10000, "추천일정", 3, ContentsTag.TRAVEL, "짧은제목",
			"짧은설명", "imageUrl", 4.5, BadgeType.NONE);
		var 저장 = contentsService.createContents(req);
		ContentsUpdateRequest 수정요청 = new ContentsUpdateRequest("제목", "설명", 10000, "추천일정", 3, ContentsTag.TRAVEL, "짧은제목",
			"짧은설명", "imageUrl", 4.5, BadgeType.NONE);
