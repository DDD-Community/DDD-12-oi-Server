...
public interface ContentsControllerDocs {
	@Operation(summary = "컨텐츠 생성", description = "컨텐츠를 생성합니다.", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "ContentsCreateRequest 예시", value = "{\"title\":\"경복궁 철쭉 스팟 총정리\",\"displayDescription\":\"종로구·10만원대\",\"cost\":150000,\"recommendedSchedule\":\"여름휴가에요\",\"duration\":360,\"contentsTag\":\"DATE\",\"shortTitle\":\"경복궁 철쭉 스팟 총정리\",\"shortDescription\":\"햇살 좋은 날, 고궁 속 산책 어때요?\",\"recommendationScore\":8.5}"))), responses = @ApiResponse(responseCode = "200", description = "컨텐츠 생성 성공", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "성공 응답 예시", value = "{\n  \"statusCode\": 200,\n  \"resultType\": \"SUCCESS\",\n  \"data\": {\n    \"id\": 1,\n    \"title\": \"경복궁 철쭉 스팟 총정리\",\n    \"displayDescription\": \"종로구·10만원대\",\n    \"cost\": 150000,\n    \"recommendedSchedule\": \"여름휴가에요\",\n    \"duration\": 360,\n    \"contentsTag\": \"DATE\",\n    \"shortTitle\": \"경복궁 철쭉 스팟 총정리\",\n    \"shortDescription\": \"햇살 좋은 날, 고궁 속 산책 어때요?\",\n    \"recommendationScore\": 8.5\n  },\n  \"message\": \"컨텐츠 생성 성공\"\n}"))))
	...
	@Operation(summary = "컨텐츠 수정", description = "컨텐츠를 수정합니다.", parameters = @Parameter(name = "contentsId", description = "컨텐츠 ID", example = "1"), requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "ContentsUpdateRequest 예시", value = "{\"title\":\"수정된 제목\",\"displayDescription\":\"수정된 설명\",\"cost\":15000,\"recommendedSchedule\":\"3박 4일\",\"duration\":180,\"contentsTag\":\"TRAVEL\",\"shortTitle\":\"수정된 짧은 제목\",\"shortDescription\":\"수정된 짧은 설명\",\"recommendationScore\":8.5}"))), responses = @ApiResponse(responseCode = "200", description = "컨텐츠 수정 성공", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "성공 응답 예시", value = "{\n  \"statusCode\": 200,\n  \"resultType\": \"SUCCESS\",\n  \"data\": {\n    \"id\": 1,\n    \"title\": \"수정된 제목\",\n    \"displayDescription\": \"수정된 설명\",\n    \"cost\": 15000,\n    \"recommendedSchedule\": \"3박 4일\",\n    \"duration\": 180,\n    \"contentsTag\": \"TRAVEL\",\n    \"shortTitle\": \"수정된 짧은 제목\",\n    \"shortDescription\": \"수정된 짧은 설명\",\n    \"recommendationScore\": 8.5\n  },\n  \"message\": \"컨텐츠 수정 성공\"\n}"))))
